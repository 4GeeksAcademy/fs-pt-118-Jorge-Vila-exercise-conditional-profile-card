...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name ? variables.name : "lucia"} ${
    variables.name ? variables.lastName : "bonette"
  }</h1>
          <h2>${variables.role ? variables.role : "Web developer"}</h2>
          <h3>${variables.city ? variables.city : "Miami"}, ${
    variables.country ? variables.country : "torre molinos"
  }</h3>
          <ul class="${
            ...
            <li><a href="https://linkedin.com/in/${
              variables.linkedin ? variables.linkedin : "singhrajvir"
...
window.onload = function() {
  window.variables = {
    ...
    socialMediaPosition: "posiion-left",
